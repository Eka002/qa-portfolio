...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    title: "Екатерина Дедяшкина — QA Engineer",
    description: "QA Engineer с 3 годами опыта в Web, API, Backend, UI/E2E-автоматизации и технической диагностике.",
    icons: { icon: "/favicon.svg", shortcut: "/favicon.svg" },
    openGraph: {
      title: "Екатерина Дедяшкина — QA Engineer",
      description: "Web, API, Backend, данные, диагностика и UI/E2E-автоматизация.",
      type: "website",
      images: socialImages,
    },
    twitter: {
